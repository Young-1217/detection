...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances_e_train_0415.json',
        # ann_file=data_root + 'annotations/instances_train.json',
        #img_prefix=data_root + 'train_clahe/',
        img_prefix=data_root + 'train_e_0415/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances_e_val_0415.json',
        # ann_file=data_root + 'annotations/instances_val.json',
        #img_prefix=data_root + 'val_clahe/',
        img_prefix=data_root + 'val_e_0415/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        # ann_file=data_root + 'annotations/instances_test_en.json',
        # img_prefix=data_root + 'test1/',
        ann_file=data_root + 'annotations/instances_e_test_0415.json',
        # ann_file=data_root + 'annotations/instances_testB.json',
        img_prefix=data_root + 'test_e_0415/',
        #img_prefix=data_root + 'test_clahe/',
        pipeline=test_pipeline))
